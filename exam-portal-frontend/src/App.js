...
import AdminAutoGenerateQuestions from "./pages/admin/questions/AdminAutoGenerateQuestions";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/adminAutoGenerateQuestions"
          element={<AdminAutoGenerateQuestions />}
        />
