...
const UserQuizManualPage = () => {
  ...
  useEffect(() => {
    ...
    if (quizId && user) {
      examProgressService.getProgress(user.userId, quizId, token).then((data) => {
        ...
        <div className="quizManualPage__content">
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                You CAN resume this quiz if interrupted. Your progress is saved automatically.
              </li>
              <li>
          ...
          <Button
            ...
            variant="primary"
          >{hasProgress ? "Resume Quiz" : "Start Quiz"}</Button>
        </div>
      ) : (
        <Loader />
      )}
